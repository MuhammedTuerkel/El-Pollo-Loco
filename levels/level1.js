...
function initLevel() {
  level1 = new level(
    ...
    (coins = [
      new coin("img/8_coin/coin_2.png", 300, 150),
      new coin("img/8_coin/coin_2.png", 600, 140),
      new coin("img/8_coin/coin_2.png", 900, 130),
      new coin("img/8_coin/coin_2.png", 1000, 120),
